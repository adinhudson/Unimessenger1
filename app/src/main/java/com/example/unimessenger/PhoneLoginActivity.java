...
public class PhoneLoginActivity extends AppCompatActivity
{
    ...
    private EditText InputPhoneNumber, InputVerificationCode, StudentID;

    private PhoneAuthProvider.OnVerificationStateChangedCallbacks callbacks;
    private FirebaseAuth mAuth;
    private DatabaseReference miuref;
    private String id;
        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                if(TextUtils.isEmpty(id)){
                    Toast.makeText(PhoneLoginActivity.this, "Please enter id number", Toast.LENGTH_SHORT).show();
                }
                ...
                else
                {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            ...
                            callbacks);        // OnVerificationStateChangedCallbacks
                                ...
                                Toast.makeText(PhoneLoginActivity.this, "ID number is invalid", Toast.LENGTH_SHORT).show();
                            }
                        }
                        @Override
