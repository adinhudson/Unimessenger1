...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position)
    {
        ...
        else  if (fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
        {
            if (fromUserID.equals(messageSenderId))
            {
                ...
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/unimessenger-386a5.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=095e1128-b849-4113-98a0-022f8bd12622")
                    ...
                    if(userMessagesList.get(position).getType().equals("pdf") || userMessagesList.get(position).getType().equals("docx"))
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i)
                            {
                                if(i == 0)
                                {
                                    deleteRecieveMessages(position, messageViewHolder);
    ...
    private void deleteRecieveMessages(final int position, final MessageViewHolder holder)
    {
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        rootRef.child("Messages")
                .child(userMessagesList.get(position).getTo())
